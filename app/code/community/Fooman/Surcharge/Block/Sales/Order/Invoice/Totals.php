...
class Fooman_Surcharge_Block_Sales_Order_Invoice_Totals extends Mage_Sales_Block_Order_Invoice_Totals {
    ...
    public function initTotals() {
        if ($this->getSource()->getOrder()->getFoomanSurchargeAmount()!= 0){
            ...
            if($parent->getTotal('subtotal_incl')){
                $parent->getTotal('subtotal_incl')->setValue($parent->getTotal('subtotal_incl')->getValue()-$this->getSource()->getFoomanSurchargeTaxAmount());
                $parent->getTotal('subtotal_incl')->setBaseValue($parent->getTotal('subtotal_incl')->getBaseValue()-$this->getSource()->getBaseFoomanSurchargeTaxAmount());
