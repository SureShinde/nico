...
class Amasty_Checkoutfees_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getFees($type)
    {
	 ...
	 /**
     * 
     * get Additional Wire transfer Fee
     * 
     */
    public function getAdditionalWireTransferFee($defaultPrice,$type=null,$order = null){
        ...
        $extraFeeAmount = $customer->getAdditionalWireTransferFee();
        
        if(!empty($extraFeeAmount)){            
            $defaultPrice = $extraFeeAmount;
        }
        }
        return $defaultPrice;
    }
