...
{
	const XML_PATH_MODULE_ACTIVE = 'frauddetection/general/enabled';
	...
	function queryMaxMind($params)
	{
		...
		foreach ($servers as $server)
		{
           ...
           // Mage::Log($response->getRawBody());
			...
			/*            patched from Direct Shop by Halo*/
...
/*            patched from Direct Shop by Halo*/
	...
	/**
	 * check if module is active for current store id
	 */
	public function isModuleActive($storeId)
	{
		return Mage::getStoreConfigFlag(static::XML_PATH_MODULE_ACTIVE, $storeId);
	}
}
