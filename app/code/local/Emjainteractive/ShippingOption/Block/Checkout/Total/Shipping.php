...
class Emjainteractive_ShippingOption_Block_Checkout_Total_Shipping extends Mage_Checkout_Block_Total_Default
{
    protected $_template = 'emjainteractive/shippingoption/checkout/total/shipping.phtml';
}