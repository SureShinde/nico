...
/**
 * @overriden block to insert grid input type as isMulti
 */
class Halox_BundleGrid_Block_Catalog_Product_View_Type_Bundle 
	...
	public function getJsonConfig()
    {
        ...
        foreach ($optionsArray as $_option) {
            ...
            foreach ($_option->getSelections() as $_selection) {
                ...
                $selectionStock = Mage::getSingleton('cataloginventory/stock_item')->loadByProduct($_selection);
                ...
                $selection = array (
                    ...
                    'stock'            => array(
                        'qty' => $selectionStock->getQty(),
                        'min_qty' => $selectionStock->getMinSaleQty(),
                        'max_qty' => $selectionStock->getMaxSaleQty()
                    ) 
                );
