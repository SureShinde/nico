...
require_once Mage::getModuleDir('controllers', 'Mage_Adminhtml') 
    . DS . 'Catalog' . DS .'CategoryController.php';

class Halox_FixCDN_Rewrite_Catalog_CategoryController extends Mage_Adminhtml_Catalog_CategoryController
{
    ...
    public function saveAction()
    {
        ...
        /**
         * Fix permission errors with I-Frames due to JS being served from CDN.
         */
        $this->getResponse()->setBody(
            '<script type="text/javascript">document.domain = /(\w+)(.\w+)?$/.exec(location.hostname)[0];parent.updateContent("' . $url . '", {}, '.$refreshTree.');</script>'
        );
    }
