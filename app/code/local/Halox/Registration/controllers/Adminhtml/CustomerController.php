...
class Halox_Registration_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController
{
    /**
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            try {
               ...
               //customer account activate/ deactivate 
                if(isset($data['account']['am_is_activated'])){
                    $customer->setAmIsActivated($data['account']['am_is_activated']);
                }
