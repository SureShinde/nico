 ...
 * @package     Halox_Salesagent
 */
abstract class Halox_Salesagent_Helper_Image_Abstract
    ...
    public function getImageBaseDir(){
         return Mage::getBaseUrl('media').'profile_image';
    }
    /**
     ...
     * @return Halox_Salesagent_Helper_Image_Abstract
          */
   ...
   /**
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|Halox_Salesagent_Helper_Image_Abstract)
          */
