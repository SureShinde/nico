...
class Halox_Taxexcisereport_Block_Adminhtml_Taxexcisereport_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
		...
		Mage::getSingleton('core/session')->setReportFilterVars($filters);
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('extra_tax_rule_amount', array(
            ...
            'align' => 'left',
            'index' => 'item_id',
            'renderer' => new Halox_Taxexcisereport_Block_Adminhtml_Taxexcisereport_Renderer_Excisetax(),
            'sortable' => false,
        ));
        if(isset($filters['region']) && $filters['region'] != 'Pennsylvania'){
        ...
        $this->addColumn('eliquid_ml', array(
            ...
            'align' => 'left',
            'index' => 'item_id',
            'renderer' => new Halox_Taxexcisereport_Block_Adminhtml_Taxexcisereport_Renderer_Taxexcisereport(),
            'sortable' => false,
        ));
        }
		if(isset($filters['region']) && $filters['region'] != 'Pennsylvania'){
