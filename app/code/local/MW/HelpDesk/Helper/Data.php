                ...
                foreach ($uploadFiles as $uploadFile) {
                    if (isset($uploadFile["name"]) && $uploadFile["name"] != '') {
                        ...
                        try {
                            ...
                            /**
                             * ISSUE: HCL-25
                             * Add more extension to validate uploaded file.
                             **/
                            $uploader->setAllowedExtensions(array('jpg','jpeg','gif','png','pdf', 'doc', 'docx','xlsx','xls','csv','avi','mov','webm','mp4','ogv'));
                            ...
                            Mage::getSingleton('customer/session')->addError(Mage::helper('helpdesk')->__('Sorry your file was not uploaded. It may be the wrong filetype. We only allow jpg, jpeg, gif, png, pdf, doc and docx filetypes.'));
                        }
                    }
                }
