...
class MW_Helpdesk_Model_Helpdeskrule_Rule_Condition_Combine extends Mage_Rule_Model_Condition_Combine
{
    public function __construct()
    {
        parent::__construct();
        $this->setType('helpdesk/helpdeskrule_rule_condition_combine');
    }

    public function getNewChildSelectOptions()
    {
        $addressCondition = Mage::getModel('helpdesk/helpdeskrule_rule_condition_address');
        $addressAttributes = $addressCondition->loadAttributeOptions()->getAttributeOption();
        $attributes = array();
        foreach ($addressAttributes as $code=>$label) {
            $attributes[] = array('value'=>'helpdesk/helpdeskrule_rule_condition_address|'.$code, 'label'=>$label);
        }
        ...
        $conditions = array_merge_recursive($conditions, array(
            ...
            array('label'=>Mage::helper('helpdesk')->__('Ticket Attributes'), 'value'=>$attributes),
        ));
