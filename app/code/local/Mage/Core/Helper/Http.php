...
class Mage_Core_Helper_Http extends Mage_Core_Helper_Abstract
{
    ...
    public function getRemoteAddr($ipToLong = false)
    {
        ...
        /**
         * HTTP_X_FORWARDED_FOR can have comma seperated multiple IPs
         * Reviews on product detail page were not working
         */
        if ($this->_getRequest()->getServer('HTTP_X_FORWARDED_FOR', false)) { 
            $addrAry = explode(',', $this->_remoteAddr);
            $this->_remoteAddr = trim($addrAry[0]);
        }
