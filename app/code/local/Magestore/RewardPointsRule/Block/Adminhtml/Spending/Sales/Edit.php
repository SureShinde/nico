    ...
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            function toggleDiscountAmount(){
                if ($('rule_discount_style').value == 'by_item_price') {
                    $('rule_discount_amount').up(1).hide();
                } else {
                    $('rule_discount_amount').up(1).show();
                }
            }
            ...
            Event.observe(window, 'load', function(){toggleDiscountAmount();});
