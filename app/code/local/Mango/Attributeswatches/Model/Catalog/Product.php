...
class Mango_Attributeswatches_Model_Catalog_Product extends Aitoc_Aitpermissions_Model_Rewrite_CatalogProduct{ //Mage_Catalog_Model_Product {  /* edit to avoid conflict with module */
