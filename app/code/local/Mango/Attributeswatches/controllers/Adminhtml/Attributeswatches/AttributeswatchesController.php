<?php
    ...
    class Mango_Attributeswatches_Adminhtml_Attributeswatches_AttributeswatchesController extends Mage_Adminhtml_Controller_Action {

        protected function _isAllowed() {
            return Mage::getSingleton('admin/session')
                            ->isAllowed('attributeswatches/items');
        }
