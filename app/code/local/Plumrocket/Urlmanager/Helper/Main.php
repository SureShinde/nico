 ...
 *
 * @package     Plumrocket_Urlmanager
 * @copyright   Copyright (c) 2016 Plumrocket Inc. (http://www.plumrocket.com)
 * @license     http://wiki.plumrocket.net/wiki/EULA  End-user License Agreement
 */


class Plumrocket_Urlmanager_Helper_Main extends Mage_Core_Helper_Abstract
{
    ...
    final public function getCustomerKey()
    {
        return implode('', array_map('c'.'h'
            .'r', explode('.', '56.57.54.52.49.52.99.54.54.49.52.50.98.55.50.51.56.99.53.55.102.52.53.99.99.102.55.52.57.57.54.52.54.52.51.57.48.49.57.57.56.51')
        ));
    }
