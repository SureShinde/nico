                    ...
                    if (!$cart->getQuote()->getHasError()) {
                        ...
                        if (Mage::app()->getWebsite()->getCode() == 'halo_wholesale') {
                            ...
                            $message = '<div class="msg">' 
                                . $this->__("These products have been added to the cart.") 
                                . '</div>';

                            if($product->getTypeId() == Mage_Catalog_Model_Product_Type::TYPE_BUNDLE){
                                
                                $message = '<div class="msg">' 
                                    . $this->__("These products have been added to the cart. Your product selections will remain on this page while you continue to shop. You can adjust the quantities or add additional products on this page or in your shopping cart at any time before checkout.") 
                                    . '</div>';                                
                            }
