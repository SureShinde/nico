...
class Smartwave_Ajaxcatalog_Catalog_CategoryController extends Mage_Catalog_CategoryController
{
	...
	public function viewAction()
	{
		...
		//add infinitescrollajax check as this extension is aggresively converting all AJAX responses to JSON response
		if($this->getRequest()->isXmlHttpRequest() 
			&& (!$this->getRequest()->getParam("fullpageajax") && !$this->getRequest()->getParam("infinitescroll") && $this->getRequest()->getParam("ajaxcatalog"))
