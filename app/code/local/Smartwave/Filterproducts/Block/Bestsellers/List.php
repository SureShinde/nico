...
//	                )
					array(
	                'flat.name AS name','flat.small_image AS small_image','flat.halo_home_slider AS halo_home_slider','flat.homepage_slider as homepage_slider','flat.homepage_slider as homepage_slider','flat.price AS price','flat.special_price as special_price','flat.special_from_date AS special_from_date','flat.special_to_date AS special_to_date'
					)
	            );
		}
