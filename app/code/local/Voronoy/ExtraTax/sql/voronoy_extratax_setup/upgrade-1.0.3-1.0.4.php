...
foreach ($tables as $table) {
    $installer->getConnection()
        ->addColumn($table,
            'base_extra_tax_payment_amount',
            array(
                'type' => Varien_Db_Ddl_Table::TYPE_DECIMAL,
                'length' => '12,4',
                'nullable'  => true,
                'comment' => 'Base Payment Excise Tax',
            )
        );
    $installer->getConnection()
        ->addColumn($table,
            'extra_tax_payment_amount',
            array(
                'type' => Varien_Db_Ddl_Table::TYPE_DECIMAL,
                'length' => '12,4',
                'nullable'  => true,
                'comment' => 'Payment Excise Tax',
            )
        );
    $installer->getConnection()
        ->addColumn($table,
