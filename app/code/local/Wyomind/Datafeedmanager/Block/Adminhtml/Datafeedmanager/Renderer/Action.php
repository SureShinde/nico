...
class Wyomind_Datafeedmanager_Block_Adminhtml_Datafeedmanager_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action
{
	public function render(Varien_Object $row)
	{
		...
		array(
		            'url'     => $this->getUrl('*/datafeedmanager_datafeedmanager/edit', array('id' => $row->getFeed_id())),
		            'caption' => Mage::helper('datafeedmanager')->__('Edit'),
		),
		array(
		            'url'     => $this->getUrl('*/datafeedmanager_datafeedmanager/delete', array('id' => $row->getFeed_id())),
		...
		array(
		            'url'     => $this->getUrl('*/datafeedmanager_datafeedmanager/sample', array('feed_id' => $row->getFeed_id(), 'limit'=>10)),
		...
		array(
		            'url'     => $this->getUrl('*/datafeedmanager_datafeedmanager/generate', array('feed_id' => $row->getFeed_id())),
