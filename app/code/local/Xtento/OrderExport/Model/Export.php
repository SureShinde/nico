        ...
        if ($this->getProfile()->getEntity() == self::ENTITY_ORDER) {
            ...
            foreach ($returnArray as $object) {
                try {
                    ...
                    Mage::getSingleton('core/session')->setOrderIdForCron($object['entity_id']);
                    Mage::getSingleton('core/session')->setOrderIdForCronToShowShipInsurance($object['entity_id']);
                    Mage::getSingleton('core/session')->setOrderIdForCronToShowExciseTax($object['entity_id']);
