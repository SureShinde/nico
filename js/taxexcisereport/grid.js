...
//        var dataElements = $(this.containerId+this.tableSufix).down('.data tbody').select('input', 'select');
    ...
    doFilter : function(){
        ...
        //alert('#'+this.containerId+' .filter input', '#'+this.containerId+' .filter select');
        //return false;
        var filters = $$('#'+this.containerId+' .filter input', '#'+this.containerId+' .filter select');
       // alert(filters);
        var elements = [];
    ...
    doFilterNew : function(){
       // alert('here');
        //alert('#taxexcisereportGrid .filter-new input', '#taxexcisereportGrid .filter-new select');
        //return false;
        
        var filters = $$('#taxexcisereportGridNew .filternew input', '#taxexcisereportGridNew .filternew select');
